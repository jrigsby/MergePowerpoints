...
//         //List<string> files = [];
//
//         string templatePath ="C:\\Temp\\template.pptx";
//         string destination ="C:\\Temp\\merged.pptx";
//         
//         try
//         {
//            
...
//                         using (var originalDoc = new PdfLoadedDocument("C:\\Temp\\big.pdf")) {
//                             originalDoc.Save(stream);
//                             var pieces = PdfLibrary.PdfHelper.SplitPdfStream(stream, Constants.ChunkSize);
//                             int i = 0;
